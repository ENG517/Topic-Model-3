**I felt like this was so different from the other two tasks that it could be made into its own little thing. the other two are basically the same, just  from diff places**
### Method 3: Seed Maker
